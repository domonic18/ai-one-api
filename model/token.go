...
type Token struct {
	...
	Group          string  `json:"group" gorm:"default:'default'"`     // token group
}
...
func (t *Token) Update() error {
	var err error
	err = DB.Model(t).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota", "models", "subnet", "group").Updates(t).Error
	return err
}
