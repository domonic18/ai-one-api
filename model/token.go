...
// SelectGroupByUserGroup 根据解析的用户组选择对应的令牌组
// 如果解析的用户组在令牌组列表中，返回该组；否则返回第一个组
func (t *Token) SelectGroupByUserGroup(userGroup string) string {
	if userGroup == "" {
